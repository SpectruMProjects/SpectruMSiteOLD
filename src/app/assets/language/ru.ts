...
export const RU: textType = {
  ...
  main: {
    ...
    aboutproject: {
      block1: {
        head: 'О проекте',
        first:
          'Наши сервера Minecraft являются уникальными и неповторимыми. Они стабильны и не содержат P2W (платные преимущества).',
        second:
      ...
      cardpay: {
        ...
        button: 'Приобрести доступ на сервер',
      },
    },
  },
  menu: {
  ...
  profile: {
    ...
    hardcore: {
      ...
      block1: {
        ...
        info4: 'Время на сервере',
        notdied: 'Не умирал',
        notbeen: 'Не был на сервере',
      },
      block2: {
        head: 'Смертей',
      },
  ...
  hardcore: {
    ...
    workhradcore: {
      ...
      note: 'Для того чтобы точно рассчитать время возрождения, мы пользуемся формулой: время до возрождения = текущее время (на момент смерти) + время на сервере (только в режиме выживания)',
    },
    checkserver: {
  ...
  errorpage: {
    text: {
      errorpage: 'Ошибка 404: Эта страница не существует',
    },
    textinfo:
      'Просим Вас, как пользователя, впредь быть внимательнее при навигации по страницам нашего сайта, чтобы не допустить ряд каких-либо ошибок. Ниже вы можете вернуться на наш сайт.',
  ...
  error: {
    ...
    errorFormLogin: {
      loginLength: 'Логин должeн содержать не менее 3х символов',
      passwordLength: 'Пароль должeн содержать не меньше 8х символов',
    },
    errorFormSignUp: {
      nicknameError:
        'Ник должен быть не меньше 3х символов, а так же содержать латинские буквы или цифры',
      mailError: 'Введите корректно почту',
      passwordError:
        'Пароль должен содержать не меньше 8и символом, а так же иметь хотя бы одну цифру и одну большую букву',
    },
    errorChangePassword: {
      change:
        'Пароль должен содержать не меньше 8и символом, а так же иметь хотя бы одну цифру и одну большую букву',
  ...
  accept: {
    account: 'Аккаунт активирован!',
    password: 'Пароль был изменен!',
  },
  notification: {
    refetch: 'Нету подключения к серверу...',
    loading: 'Загрузка данных...',
    copy: 'Строка скопирована',
  },
}
